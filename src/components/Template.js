...
const Template = ({ title, desc1, desc2, image, formtype, setIsLoggedIn }) => {
    ...
    return (
        <div className='flex justify-between w-11/12 max-w-[1160px] py-12 mx-auto gap-x-12 gap-y-0 h-screen'>
            ...
            <div className='relative w-11/12 max-w-[450px] max-h-screen'>
                <img src={frameImage}
                    alt="Pattern"
                    width={558}
                    height={504}
